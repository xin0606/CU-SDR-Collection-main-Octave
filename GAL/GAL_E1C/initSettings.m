...
% based only. 
settings.skipNumberOfBytes     = 100*2*2*5e6;

%% Raw signal file name and other parameter ===============================
% This is a "default" name of the data file (signal record) to be used in
% the post-processing mode

settings.fileName           = "C:\Users\CNSL-HSIN\Desktop\CNSL_Matlab_VT_SDR\cnsl_static_x300_ext_1104.dat";
...
settings.acqSearchBand      = 10000;%5000;       % [Hz]
...
settings.resamplingThreshold    = 5e6;           % [Hz]
...
settings.dllCorrelatorSpacing    = 0.15;     %[chips]

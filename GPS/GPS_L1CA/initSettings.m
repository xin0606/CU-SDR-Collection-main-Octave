...
% based only.
settings.skipNumberOfBytes     = 2.4e6*4;

%% Raw signal file name and other parameter ===============================
% This is a "default" name of the data file (signal record) to be used in
% the post-processing mode
settings.fileName           ="C:/Users/CNSL-HSIN/Documents/CU-SDR-Collection-main-Octave/rtlsdr_L1_100sec.dat";
...
settings.IF                 = 0;     % [Hz]
settings.samplingFreq       = 2.4e6;        % [Hz]
...
settings.acqSearchBand      = 20000;           %[Hz]
...
settings.pllNoiseBandwidth       = 40;      %[Hz]

...
if (fid > 0)
   ...
   if settings.dataType == 'uint8'
    ...
    if (settings.fileType==1) %Real Data
        subplot(2,2,1:2);
        pwelch(data, 32768, 2048/32768, 32768, settings.samplingFreq/1e6)
    else % I/Q Data
        subplot(3,2,1:2);
        [sigspec,freqv]=pwelch(data, 32768, 2048/32768, 32768, settings.samplingFreq,'twosided');
